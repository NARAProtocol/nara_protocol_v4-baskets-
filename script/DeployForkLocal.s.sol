...
contract DeployForkLocal is Script {
    ...
    function run() external {
        ...
        UniswapV4BasketAdapterV1 v4 = new UniswapV4BasketAdapterV1(UNIVERSAL_ROUTER, PERMIT2, 3000, 60, address(0x1));
    ...
    function _deploy(
        ...
        NARAImmutableBasketPositionManagerV1 mgr =
            new NARAImmutableBasketPositionManagerV1(name, "NARABP", NARA_STANDIN, 500, config);
        return address(mgr);
    }
